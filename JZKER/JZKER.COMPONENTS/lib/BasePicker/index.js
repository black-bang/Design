...
var _BasePicker = __webpack_require__(209);

var _BasePicker2 = _interopRequireDefault(_BasePicker);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _BasePicker2.default;
...
var ChildDisplay = function ChildDisplay(props) {
...
var BasePicker = (_temp = _class = function (_React$Component) {
	...
	_createClass(BasePicker, [{
		...
		value: function render() {
			return React.createElement(
				...
				React.createElement(ChildDisplay, null)
			);
		}
	}]);
	...
	function BasePicker(props) {
		...
		_this.handleChange = function (value) {
			...
			_this.props.onChange({ keyname: _this.props.keyname, keyvalue: value[0] });
		};

		_this.handleOk = function (value) {
			_this.setState({ value: value });
			_this.props.onEnter({ keyname: _this.props.keyname, keyvalue: value[0] });
		};
	...
	_createClass(BasePicker, [{
		...
		get: function get() {
			//将data抹平成标准的data
			return this.props.data.map(function (dataUnit, index) {
	...
	onChange: function onChange(pickerOBJ) {/*console.log(pickerOBJ)*/},
	onEnter: function onEnter(pickerOBJ) {/*console.log(pickerOBJ)*/}
}, _class.propTypes = {
	relation: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
}, _class.type = {
	AP: function AP(pramaOBJ) {
		//ArithmeticProgression等差数列
		var ExperienceArray = new Array();
		var defaultConfig = Object.assign({ strat: 0, step: 1, loop: 100, unit: "年" }, pramaOBJ);
		for (var i = defaultConfig["strat"]; i < defaultConfig["loop"]; i = i + defaultConfig["step"]) {
