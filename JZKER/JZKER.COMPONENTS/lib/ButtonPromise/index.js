...
var _ButtonPromise = __webpack_require__(211);

var _ButtonPromise2 = _interopRequireDefault(_ButtonPromise);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _ButtonPromise2.default;
...
var _ButtonPromise = __webpack_require__(212);
...
var ButtonPromise = (_temp = _class = function (_React$PureComponent) {
	_inherits(ButtonPromise, _React$PureComponent);

	_createClass(ButtonPromise, [{
		key: "render",
		value: function render() {
			if (this.props.to) {
				return React.createElement(
					_reactRouterDom.NavLink,
					{ to: this.props.to, className: this.ButtonPromiseClass, style: Object.assign({}, this.ComputedStyle, this.props.style) },
					this.props.children
				);
			} else {
				return React.createElement(
					"div",
					{ className: this.ButtonPromiseClass, style: Object.assign({}, this.ComputedStyle, this.props.style), onClick: this.handleClick },
	...
	function ButtonPromise(props) {
		var _this2 = this;

		_classCallCheck(this, ButtonPromise);

		var _this = _possibleConstructorReturn(this, (ButtonPromise.__proto__ || Object.getPrototypeOf(ButtonPromise)).call(this, props));

		_this.handleClick = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
				...
				while (1) {
					switch (_context.prev = _context.next) {
						...
						case 4:
							...
							_this.setState({ status: "PEDDING" });
							_context.next = 8;
							return _this.props.onClick();

						case 8:
							if (_this._isMount) {
								_this.setState({ status: "COMPLATE" });
							}
							_context.next = 15;
							break;
	...
	_createClass(ButtonPromise, [{
		...
		key: "ButtonPromiseClass",
		get: function get() {
			return classnames([_ButtonPromise2.default["ButtonPromise"], this.props.className]);
		}
	}, {
		key: "ComputedStyle",
		get: function get() {
		...
		key: "StatusTipComponent",
		get: function get() {
			//等待提醒
			if (this.state.status == "PEDDING") {
				return React.createElement(_icon2.default, { type: "loading", size: "xxs", color: "#ffffff" });
			} else {
...
// removed by extract-text-webpack-plugin
module.exports = {"ButtonPromise":"ButtonPromise-1w2ad1Ro6YebjqcZtU1oMy"};
