...
var _TabSwitch = __webpack_require__(266);

var _TabSwitch2 = _interopRequireDefault(_TabSwitch);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _TabSwitch2.default;
...
var _TabSwitch = __webpack_require__(267);

var _TabSwitch2 = _interopRequireDefault(_TabSwitch);

var _TabSwitchItem = __webpack_require__(268);

var _TabSwitchItem2 = _interopRequireDefault(_TabSwitchItem);

var _TabSwitchButtonItem = __webpack_require__(270);

var _TabSwitchButtonItem2 = _interopRequireDefault(_TabSwitchButtonItem);

var _TabSwitchLinkItem = __webpack_require__(272);

var _TabSwitchLinkItem2 = _interopRequireDefault(_TabSwitchLinkItem);
...
var TabSwitch = (_temp = _class = function (_React$Component) {
	_inherits(TabSwitch, _React$Component);

	_createClass(TabSwitch, [{
		key: "render",
		value: function render() {
			var TabSwitchClass = classnames(_TabSwitch2.default["TabSwitch-BeatTest"], this.props.className);
			return React.createElement(
				"div",
				{ className: TabSwitchClass, style: this.props.style },
				React.createElement(
					"div",
					{ className: _TabSwitch2.default["TabSwitch-BeatTest-inner"] },
					this.props.children
				)
			);
		}
	...
	function TabSwitch(props) {
		...
		var _this = _possibleConstructorReturn(this, (TabSwitch.__proto__ || Object.getPrototypeOf(TabSwitch)).call(this, props));

		_this.getChildContext = function () {
			return {
				TabSwitch: {
					keyname: _this.state.keyname,
					switchAction: function switchAction(switchItem) {
						_this.setState({ keyname: switchItem });
						_this.props.onChange({ keyname: switchItem });
					}
				}
			};
		};
	...
	onChange: function onChange(switchOBJ) {}
}, _class.Item = _TabSwitchItem2.default, _class.LinkItem = _TabSwitchLinkItem2.default, _class.ButtonItem = _TabSwitchButtonItem2.default, _temp);
...
module.exports = {"TabSwitch-BeatTest":"TabSwitch-BeatTest-28PEa_7qUTwxulEoYDg7ID","TabSwitch-BeatTest-inner":"TabSwitch-BeatTest-inner-3ka28skHPi-8UyWgzyB7qi"};
...
var _TabSwitchItem = __webpack_require__(269);
...
var TabSwitchItem = (_temp = _class = function (_React$Component) {
	_inherits(TabSwitchItem, _React$Component);

	_createClass(TabSwitchItem, [{
		key: "render",
		value: function render() {
			var _classnames;

			var TabSwitchItemClass = classnames((_classnames = {}, _defineProperty(_classnames, _TabSwitchItem2.default["TabSwitchItem-Beat"], true), _defineProperty(_classnames, this.props.activeClassName || _TabSwitchItem2.default["TabSwitchItem-Beat-active"], this.state.active), _classnames), this.props.className);
			return React.createElement(
				"div",
				{ className: TabSwitchItemClass, onClick: this.handleClick },
				this.props.children
			);
		}
	}]);

	function TabSwitchItem(props) {
		_classCallCheck(this, TabSwitchItem);

		var _this = _possibleConstructorReturn(this, (TabSwitchItem.__proto__ || Object.getPrototypeOf(TabSwitchItem)).call(this, props));

		_this.handleClick = function () {
			var keyname = _this.context.TabSwitch.keyname;

			_this.props.onClick(_this.props);
			if (keyname !== _this.props.keyname) {
				_this.context.TabSwitch.switchAction(_this.props.keyname);
			} else {
				return false;
			}
		};
	...
	_createClass(TabSwitchItem, [{
		...
		value: function componentWillUpdate(nextProps, nextState, nextContext) {
			var keyname = nextContext.TabSwitch.keyname;
...
// removed by extract-text-webpack-plugin
module.exports = {"TabSwitchItem-Beat":"TabSwitchItem-Beat-3pmDxUMGC62CGU6aHqpm-e","TabSwitchItem-Beat-active":"TabSwitchItem-Beat-active-2DTfgy6xFh8QK48RUXQGUz"};
...
var _TabSwitchButtonItem = __webpack_require__(271);
...
var TabSwitchButtonItem = (_temp = _class = function (_React$Component) {
	_inherits(TabSwitchButtonItem, _React$Component);

	_createClass(TabSwitchButtonItem, [{
		key: "render",
		value: function render() {
			var _classnames;

			var TabSwitchItemClass = classnames((_classnames = {}, _defineProperty(_classnames, _TabSwitchButtonItem2.default["TabSwitchButtonItem-Beat"], true), _defineProperty(_classnames, _TabSwitchButtonItem2.default["TabSwitchItem-ButtonItem-active"], this.state.active), _classnames), this.props.className);
			return React.createElement(
				"div",
				{ className: TabSwitchItemClass, onClick: this.handleClick },
				this.props.children
	...
	function TabSwitchButtonItem(props) {
		_classCallCheck(this, TabSwitchButtonItem);

		var _this = _possibleConstructorReturn(this, (TabSwitchButtonItem.__proto__ || Object.getPrototypeOf(TabSwitchButtonItem)).call(this, props));
...
exports.default = TabSwitchButtonItem;
...
// removed by extract-text-webpack-plugin
module.exports = {"TabSwitchButtonItem-Beat":"TabSwitchButtonItem-Beat-_q1gVL3I6I0zHWrJmSV6j","TabSwitchItem-ButtonItem-active":"TabSwitchItem-ButtonItem-active-3p7W4cvRO7Z0XssDWpbi0X"};
...
var _TabSwitchLinkItem = __webpack_require__(273);
...
var TabSwitchLinkItem = function TabSwitchLinkItem(props) {
	var TabSwitchLinkItemClass = classnames(_defineProperty({}, _TabSwitchLinkItem2.default["TabSwitchLinkItem"], true), props.className);
	return React.createElement(
		_reactRouterDom.NavLink,
		{ to: props.to, className: TabSwitchLinkItemClass },
		props.children
	);
};

exports.default = TabSwitchLinkItem;
...
// removed by extract-text-webpack-plugin
module.exports = {"TabSwitchLinkItem":"TabSwitchLinkItem-2yYvRGSmrgjggGDHBxayRv"};
